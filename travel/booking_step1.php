...
if (empty($_SESSION['loggedin'])) {
    header('Location: '.BASE.'/login.php?redirect='.urlencode(BASE.'/travel/booking_step1.php')); exit;
}
$navActive = '';
...
<div class="page-hero">
  <div class="tag"><i class="fas fa-bus"></i> Travel Booking</div>
  <h1>Book a Travel Vehicle</h1>
  <p>Find comfortable passenger vehicles for your journey</p>
</div>
...
<div class="form-wrap">
  <div class="form-card reveal">
    <h2><i class="fas fa-clipboard-list"></i> Enter Your Trip Details</h2>
