<?php
session_start();
if (empty($_SESSION['loggedin'])) { header('Location: '.BASE.'/front/login.php?redirect='.urlencode(BASE.'/transport/booking_step1.php')); exit; }
...
<body>
<div class="page-hero"><h1>🚚 Book Transport Vehicle</h1><p>Find available transport vehicles near your pickup location</p></div>
<div class="steps-nav">
